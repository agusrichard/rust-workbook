...
Your task is to:
1. Convert the challenge title into snake_case format suitable for a Rust crate name.
   - Example: "Return the first M multiples of N" -> "return_the_first_m_multiples_of_n"
